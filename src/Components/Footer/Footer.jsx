...
const Footer = () => {
  ...
  return (
    <footer className="border-t border-gray-200 mt-12">
      {/* top section */}
      <div className="container mx-auto py-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-6 lg:gap-8 text-center sm:text-left text-gray-700">
        {/* logo */}
        <div className="lg:col-span-2">
          <div className="flex items-center justify-center sm:justify-start gap-3 mb-3">
            ...
            <h2 className="text-2xl font-semibold text-gray-800">Siam</h2>
          </div>
          ...
          <div className="flex gap-3 justify-center sm:justify-start">
            <button className="flex items-center gap-2 px-3 py-2 border rounded-md text-sm hover:shadow-md transition-all duration-300 cursor-pointer">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li className="flex items-center justify-center sm:justify-start gap-2">
              <HiOutlineLocationMarker className="text-green-600 w-5 h-5" />
      ...
      <div className="border-t border-gray-200  py-4">
        <div className="container mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-gray-500">
          ...
          <div className="flex items-center gap-3 text-2xl text-gray-600 ">
            <FaCcVisa className="hover:text-green-600 cursor-pointer duration-300 transition-all" />
            <FaCcMastercard className="hover:text-green-600 cursor-pointer duration-300 transition-all" />
            <FaCcPaypal className="hover:text-green-600 cursor-pointer duration-300 transition-all" />
            <FaCcAmex className="hover:text-green-600 cursor-pointer duration-300 transition-all" />
          </div>
        </div>
      </div>
    </footer>
